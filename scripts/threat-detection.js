...
class ThreatDetectionSystem {
    constructor() {
        ...
        this.alertThresholds = {
            largeTransaction: hardhat_1.ethers.parseEther("100"), // 100 ETH
            highGasPrice: hardhat_1.ethers.parseUnits("100", "gwei"),
    ...
    detectUnusualActivity(blockNumber) {
        const threat = {
    ...
    detectGasAnomaly(gasPrice) {
        if (gasPrice > this.alertThresholds.highGasPrice) {
            const threat = {
                ...
                type: 'gas_anomaly',
                severity: 'high',
                description: `Unusually high gas price detected: ${hardhat_1.ethers.formatUnits(gasPrice, "gwei")} gwei`,
                timestamp: new Date().toISOString(),
                recommendations: [
    ...
    async generateThreatReport() {
        ...
        return {
            ...
            networkStatus: {
                blockNumber,
                gasPrice: hardhat_1.ethers.formatUnits(gasPrice.gasPrice || 0n, "gwei") + " gwei",
